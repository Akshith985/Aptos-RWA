...
export default function InvoiceList({ invoices, searchTerm, setSearchTerm, view }: InvoiceListProps) {
    // Status mapping
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Transfer dialog (Moved outside the loop for performance/correctness) */}
            {transferOpen && (
                <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-sm flex flex-col gap-4 border border-slate-200">
                        ...
                        <p className="text-sm text-slate-600 mb-2">
                            Enter the recipient's Aptos address to transfer invoice: <br/>
                            <span className="font-mono bg-slate-100 px-2 py-0.5 rounded text-xs break-all">
                                {transferInvoiceId}
                            </span>
                        </p>
                        <input
                        ...
                        <div className="flex gap-2 mt-2">
                            ...
                            >
                                {transferStatus === "Transferring..." ? "Transferring..." : "Confirm"}
                            </button>
                            <button
                        ...
                        {transferStatus && (
                            <div className="text-center text-xs text-green-600 mt-2 font-medium">{transferStatus}</div>
                        )}
                    </div>
                </div>
            )}
